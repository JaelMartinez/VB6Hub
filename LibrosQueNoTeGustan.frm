...
Private Sub cmdEliminar_Click()
    ...
    respuesta = MsgBox("¿Está seguro de que desea eliminar el libro '" & TituloLibro & "' de la lista de libros que no te gustaron?", vbYesNo + vbQuestion, "Confirmar Eliminación")
